...
$user = "if0_39005044";
$password = "14061999Tudu";
$db = "if0_39005044_db_shop";
        ...
        <div class="login-container">
            ...
            <div class="login-body">
                ...
                <div class="login-tabs">
                    <div class="login-tab active">Bằng OTP</div>
                    <div class="login-tab">Email/Số điện thoại</div>
                </div>
    ...
    <script>
        ...
        tabs.forEach(tab => {
            tab.addEventListener('click', () => {
                ...
                // Here you would add logic to switch between OTP and email login
